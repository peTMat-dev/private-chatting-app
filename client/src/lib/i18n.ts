...
const translations: Record<LangCode, Translations> = {
  en: {
    ...
    addPublicUser: "Add Public User",
    loadingUsers: "Loading users...",
    noPublicUsers: "No public users available",
    requestByName: "Request by Name",
    enterDisplayName: "Enter display name",
    sendRequest: "Send Request",
    backendNotImplemented: "Note: Backend not yet implemented",
  ...
  es: {
    ...
    addPublicUser: "Añadir usuario público",
    loadingUsers: "Cargando usuarios...",
    noPublicUsers: "No hay usuarios públicos disponibles",
    requestByName: "Solicitar por nombre",
    enterDisplayName: "Introduce el nombre visible",
    sendRequest: "Enviar solicitud",
    backendNotImplemented: "Nota: Backend aún no implementado",
  ...
  fr: {
    ...
    addPublicUser: "Ajouter un utilisateur public",
    loadingUsers: "Chargement des utilisateurs...",
    noPublicUsers: "Aucun utilisateur public disponible",
    requestByName: "Demander par nom",
    enterDisplayName: "Entrez le nom affiché",
    sendRequest: "Envoyer la demande",
    backendNotImplemented: "Note : Backend pas encore implémenté",
  ...
  de: {
    ...
    addPublicUser: "Öffentlichen Nutzer hinzufügen",
    loadingUsers: "Nutzer werden geladen...",
    noPublicUsers: "Keine öffentlichen Nutzer verfügbar",
    requestByName: "Nach Name anfragen",
    enterDisplayName: "Anzeigenamen eingeben",
    sendRequest: "Anfrage senden",
    backendNotImplemented: "Hinweis: Backend noch nicht implementiert",
