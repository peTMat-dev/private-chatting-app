...
CREATE TABLE IF NOT EXISTS `cubcha_v1`.`user_system_details` (
    ...
    `system_color_theme` ENUM('light', 'dark') NOT NULL DEFAULT 'light' COMMENT 'User preferred color theme',
    `cube_color` ENUM('blue', 'green', 'red', 'purple', 'orange', 'brown') NOT NULL DEFAULT 'blue' COMMENT 'System default color theme',
